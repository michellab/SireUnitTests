...
def setupMovesFreeEnergy(system, random_seed, REFERENCE, lam_val):
...
def test_cr(TOP, CRD, PERT, RULE):
    ...
    moves = setupMovesFreeEnergy(system, ranseed, reference.val, lambda_val.val)
...
if __name__ == '__main__':
    ...
    print ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print ("The difference of the single point energies for a toluene- methane perturbation is %s kcal/mol when using geometric and arithmetic combining rules" %d)
    print ("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    if abs(d) > 0.0001:
        if verbose:
