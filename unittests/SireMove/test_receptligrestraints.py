...
def setupMoves(system, debug_seed, GPUS):
    ...
    Integrator_OpenMM = OpenMMFrEnergyST(molecules)
...
def getPotEnergy(boresch_restraints_on):
    ...
    moves = setupMovesFreeEnergy(system, debug_seed.val, gpu.val, lam_val=0)
...
def test_boresch_restraints(verbose=False):
    ...
    a = getPotEnergyFr(True)
    b = getPotEnergyFr(False)
    print(a)
    print(b)
    print(a-b)
